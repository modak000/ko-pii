...
# ─────── DT_BIRTH (생년월일) ───────
_add("DT_BIRTH", "한국어 풀 형식", "생년월일: 1988년 1월 1일")
_add("DT_BIRTH", "0 padding", "생일 1995년 03월 15일")
_add("DT_BIRTH", "년생 marker", "88년생 입니다")
_add("DT_BIRTH", "4자리 년생", "1988년생")
_add("DT_BIRTH", "숫자 점 구분", "생일은 1988.01.01")
_add("DT_BIRTH", "숫자 하이픈", "생년월일 1988-01-01")
_add("DT_BIRTH", "숫자 슬래시", "생일 1988/01/01")
_add("DT_BIRTH", "2자리 연도", "생일 88.01.01")
_add("DT_BIRTH", "DOB 영문", "DOB: 1988년 1월 1일")
_add("DT_BIRTH", "키워드 없음 (거부)", "회의는 2024년 4월 15일",
     "단순 날짜 — 키워드 없으면 거부")
_add("DT_BIRTH", "잘못된 월 (거부)", "생년월일 1988년 13월 1일",
     "13월 = 무효")
_add("DT_BIRTH", "윤년 (1988-02-29)", "생일 1988년 2월 29일")
_add("DT_BIRTH", "비윤년 (1987-02-29 거부)",
     "생일 1987년 2월 29일", "1987년 비윤년")

# ─────── EDUCATION (학력) ───────
_add("EDUCATION", "서울대", "서울대학교 졸업")
_add("EDUCATION", "연세대", "연세대학교 신촌캠퍼스 출신")
_add("EDUCATION", "고려대", "고려대학교 학사")
_add("EDUCATION", "KAIST", "KAIST 박사")
_add("EDUCATION", "카이스트 한글", "카이스트 출신")
_add("EDUCATION", "포스텍", "POSTECH 학부")
_add("EDUCATION", "약칭 — 서울대", "서울대 입학 예정",
     "약칭도 정식명으로 매핑")
_add("EDUCATION", "지방 거점", "부산대학교 동아리")
_add("EDUCATION", "전문대", "동양미래대학교 재학")
_add("EDUCATION", "교대", "춘천교육대학교")
_add("EDUCATION", "사관학교", "공군사관학교 출신")
_add("EDUCATION", "가짜 대학 (거부)", "뽀로로대학교 다님",
     "사전 화이트리스트 외 거부")

# ─────── MAJOR (전공) ───────
_add("MAJOR", "공학 — 컴공", "컴퓨터공학과 졸업")
_add("MAJOR", "공학 — 전자", "전자공학 전공")
_add("MAJOR", "사회 — 경영", "경영학부 학생")
_add("MAJOR", "법학", "법학 전공")
_add("MAJOR", "의예", "의예과 입학")
_add("MAJOR", "수학", "수학 전공")
_add("MAJOR", "교육 — 국어교육", "국어교육학과")
_add("MAJOR", "예체능 — 음악", "음악학과")
_add("MAJOR", "정규화 — 학과 접미사",
     "컴퓨터공학과", "정식명: 컴퓨터공학")
_add("MAJOR", "가짜 전공 (거부)", "뽀로로공학과",
     "사전 화이트리스트 외 거부")

# ─────── POSITION (직책) ───────
_add("POSITION", "직급 + 사무관", "직급: 사무관")
_add("POSITION", "직책 + 부장", "직책 부장")
_add("POSITION", "직위 + 과장", "직위: 과장")
_add("POSITION", "보직 + 팀장", "보직: 팀장")
_add("POSITION", "키워드 없음 (거부)", "사무관이 결재",
     "PERSON 컨텍스트로만 사용, 단독 emit X")

# ─────── AGE / HEIGHT / WEIGHT (측정치 — 결합위험도용) ───────
_add("AGE", "세", "나이 32세")
_add("AGE", "살", "32살")
_add("AGE", "범위 초과 (거부)", "200세 노인",
     "0-150 범위 외 거부")
_add("HEIGHT", "cm", "키 175cm")
_add("HEIGHT", "센티", "175센티")
_add("HEIGHT", "센티미터", "175센티미터")
_add("WEIGHT", "kg", "몸무게 70kg")
_add("WEIGHT", "킬로", "70킬로")
_add("WEIGHT", "킬로그램", "70킬로그램")
_add("WEIGHT", "범위 초과 (거부)", "500kg",
     "1-300 범위 외 거부")
