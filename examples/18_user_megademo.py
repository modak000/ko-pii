...
# ─────── PHONE (전화번호) ───────
_add("PHONE", "010 휴대 하이픈", "010-1234-5678")
_add("PHONE", "010 휴대 점", "010.1234.5678")
_add("PHONE", "010 휴대 공백", "010 1234 5678")
_add("PHONE", "010 휴대 합친", "01012345678")
_add("PHONE", "011 (구형)", "011-222-3333")
_add("PHONE", "016 (구형)", "016-333-4444")
_add("PHONE", "017 (구형)", "017-444-5555")
_add("PHONE", "018 (구형)", "018-555-6666")
_add("PHONE", "019 (구형)", "019-666-7777")
_add("PHONE", "국제 +82", "+82-10-1234-5678")
_add("PHONE", "국제 0082", "0082 10 9876 5432")
_add("PHONE", "서울 일반 (02)", "02-3456-7890")
_add("PHONE", "경기 (031)", "031-987-6543")
_add("PHONE", "인천 (032)", "032-111-2222")
_add("PHONE", "강원 (033)", "033-444-5555")
_add("PHONE", "대전 (042)", "042-666-7777")
_add("PHONE", "광주 (062)", "062-888-9999")
_add("PHONE", "부산 (051)", "051-111-3333")
_add("PHONE", "VoIP (070)", "070-7878-1234")

# ─────── FAX ───────
_add("FAX", "팩스 한글 키워드", "팩스: 02-123-4567")
_add("FAX", "FAX 영문", "FAX 031-555-6677")
_add("FAX", "전송 키워드", "전송 02-999-8888")
...
# ─────── PERSON (사람 이름) ───────
_add("PERSON", "성명 라벨 (단일성씨)", "성명: 홍길동")
_add("PERSON", "성명 라벨 (복성)", "성명: 남궁민수")
_add("PERSON", "성명 라벨 (황보)", "참석자: 황보경")
_add("PERSON", "신청인 라벨", "신청인: 김민수")
_add("PERSON", "민원인 라벨", "민원인 박영수")
_add("PERSON", "기안자 라벨", "기안자: 이수정")
_add("PERSON", "결재자 라벨", "결재자 최지훈")
_add("PERSON", "환자 라벨 (의료)", "환자: 강도현")
_add("PERSON", "직책 인접 (과장 뒤)", "박영수 과장님께")
_add("PERSON", "직책 인접 (장관 뒤)", "김민수 장관 발표")
_add("PERSON", "직책 인접 (의원 뒤)", "이수정 의원 질의")
_add("PERSON", "직책 인접 (검사 뒤)", "최지훈 검사 수사")
_add("PERSON", "직책 인접 (앞쪽)", "과장 김민수 보고")
_add("PERSON", "자연어 조사 (이)", "장혁이 영화에 출연")
_add("PERSON", "자연어 조사 (가)", "박해일이가 도착")
_add("PERSON", "자연어 조사 (은)", "유시진은 군인이다")
_add("PERSON", "자연어 조사 (의)", "홍길동의 신분증")
_add("PERSON", "3중 매크로 — 정형 부처", "기획재정부 김민수 장관")
_add("PERSON", "3중 매크로 — 약칭", "기재부 박영수 사무관")
_add("PERSON", "3중 매크로 — 환경부", "환경부 이수정 차관")
_add("PERSON", "3중 매크로 — 외교부 + 대사", "외교부 강도현 대사")
_add("PERSON", "3중 매크로 — 법무부 + 검사", "법무부 정혜진 검사")
_add("PERSON", "3중 매크로 — 경찰청", "경찰청 최지훈 경감")
_add("PERSON", "3중 매크로 — 소방청", "소방청 박영수 소방위")
_add("PERSON", "3중 매크로 — 대통령실", "대통령실 강도현 정무수석")
_add("PERSON", "3중 매크로 — 국회", "국회 박영수 의원")
_add("PERSON", "나이/성별 인접", "민원인 홍길동(45세)")
_add("PERSON", "성별 인접 (괄호)", "신청자 김민수(남)")
_add("PERSON", "성별 인접 (콤마)", "박영수, 남자")
_add("PERSON", "공무원 부정 (기관명)", "보건복지부는 검토 후",
     "부처명 자체는 PERSON 아님")
_add("PERSON", "동음이의 부정 (검토)", "검토 결과 모두 적정",
     "일반 단어 — common_words 거부")
_add("PERSON", "한자 (미지원)", "참석자: 洪吉童",
...
# ─────── EMPLOYEE_ID ───────
_add("EMPLOYEE_ID", "사번 키워드", "사번: 20231234")
_add("EMPLOYEE_ID", "공무원번호", "공무원번호 123456")
_add("EMPLOYEE_ID", "교번", "교번 789012")
...
_add("RRN", "줄바꿈 인접", "성명 홍길동\n주민 880101-1234568")
_add("RRN", "표 안에 표기", "| 성명 | 주민번호 |\n| 홍 | 880101-1234568 |")
...
# ─────── PHONE 추가 (전국 지역번호) ───────
_add("PHONE", "대구 (053)", "053-444-5555")
_add("PHONE", "울산 (052)", "052-222-3333")
_add("PHONE", "충북 (043)", "043-333-4444")
_add("PHONE", "충남 (041)", "041-555-6666")
_add("PHONE", "전북 (063)", "063-777-8888")
_add("PHONE", "전남 (061)", "061-999-0000")
_add("PHONE", "경북 (054)", "054-111-2222")
_add("PHONE", "경남 (055)", "055-333-4444")
_add("PHONE", "제주 (064)", "064-555-6666")
_add("PHONE", "세종 (044)", "044-777-8888")
_add("PHONE", "안심번호 (050X)", "050-1234-5678")
_add("PHONE", "전국 대표 (1588)", "1588-1234", "특수번호도 PII 잠재")
_add("PHONE", "괄호 시외 (02)", "(02) 1234-5678")
_add("PHONE", "다국적 표기 +82-2", "+82-2-1234-5678")
_add("PHONE", "여러 개 한 문장",
     "유선 02-1234-5678 / 휴대 010-9876-5432")

# ─────── FAX 추가 ───────
_add("FAX", "팩스 + 지역 외", "팩스 031-555-6677")
_add("FAX", "Fax 콜론", "Fax: 02-123-4567")
_add("FAX", "여러 개 한 문장",
     "전송 02-999-8888, FAX 031-444-5555")
...
# ─────── PERSON 추가 (성씨/이름 다변화) ───────
_add("PERSON", "성명 — 신씨", "성명: 신혜진")
_add("PERSON", "성명 — 한씨", "성명 한지민")
_add("PERSON", "성명 — 송씨", "성명: 송중기")
_add("PERSON", "성명 — 류씨 (드문)", "성명: 류현진")
_add("PERSON", "성명 — 노씨", "성명: 노태우")
...
_add("PERSON", "이름 라벨", "이름: 박철수")
_add("PERSON", "본인 라벨", "본인: 김민지")
_add("PERSON", "고객 라벨", "고객명: 박영수")
_add("PERSON", "직책 인접 (대표)", "홍길동 대표가 발표")
_add("PERSON", "직책 인접 (회장)", "이수정 회장님 인사")
_add("PERSON", "직책 인접 (사장)", "박영수 사장이 결재")
_add("PERSON", "직책 인접 (이사)", "김민수 이사 면담")
_add("PERSON", "직책 인접 (변호사)", "정혜진 변호사 선임")
_add("PERSON", "직책 인접 (교수)", "최지훈 교수가 강의")
_add("PERSON", "직책 인접 (박사)", "강도현 박사가 발표")
_add("PERSON", "직책 인접 (소령)", "김민수 소령")
_add("PERSON", "직책 인접 (경위)", "박영수 경위")
_add("PERSON", "직책 인접 (군수)", "이수정 군수")
_add("PERSON", "직책 인접 (시장)", "최지훈 시장 회견")
_add("PERSON", "직책 인접 (구청장)", "강도현 구청장")
_add("PERSON", "직책 인접 (도지사)", "박영수 도지사 결정")
_add("PERSON", "직책 인접 (총장)", "이수정 총장")
_add("PERSON", "직책 인접 (대법관)", "정혜진 대법관")
...
_add("PERSON", "3중 매크로 — 헌법재판소 + 헌법재판관",
     "헌법재판소 박영수 헌법재판관")
_add("PERSON", "이름 + 씨", "박영수 씨")
_add("PERSON", "이름 + 님", "박영수 님")
_add("PERSON", "이름 + 선생님", "박영수 선생님")
...
_add("EMPLOYEE_ID", "사번 콜론", "사번:20231234")
...
"""),
    ...
    ("종합 다중 PII 단일 문단 (혼합)", """담당관 김민수 사무관(010-1234-5678,
