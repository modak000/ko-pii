...
LEGAL_BASIS_BY_LABEL: dict[str, str] = {
    ...
    "POSITION": "개인정보보호법 제2조; 「개인정보 비식별 조치 가이드라인」 준식별자",
    "AGE": "개인정보보호법 제2조; 「개인정보 비식별 조치 가이드라인」 준식별자",
    "HEIGHT": "개인정보보호법 제2조; 「개인정보 비식별 조치 가이드라인」 준식별자",
    "WEIGHT": "개인정보보호법 제2조; 「개인정보 비식별 조치 가이드라인」 준식별자",
}
